...
router.get('/display', function(req, res, next) {
    ...
    if (err) {
        ...
        res.render('state/display-state', { mydata: db_states_array });
      }
  }).lean();
});
...
router.get('/show/:id', function(req, res) {
  ...
  StateModel.findById(req.params.id, function(err, db_states_array) {
      if (err) {
          ...
          res.render('category/single-category-record', { mydata: db_states_array });
      }
  });
});
...
router.get('/edit/:id', function(req, res) {
  ...
  StateModel.findById(req.params.id, function(err, db_states_array) {
      if (err) {
          ...
          console.log(db_states_array);
          res.render('state/edit-state', { mydata: db_states_array });
      }
  }).lean();
});
