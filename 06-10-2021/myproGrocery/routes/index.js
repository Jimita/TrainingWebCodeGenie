...
const {getLogin, getLoginProcess} = require("../controllers/login-controller");
const { getSignup, getSignupProcess } = require('../controllers/signup-controller');
const { getHome } = require('../controllers/home-controller');
const { getChangePassword, getChangePasswordProcess } = require('../controllers/change-password-controller');
const { getForgotPassword, getForgotPasswordProcess } = require('../controllers/forgot-password-controller');
const { getUserDetails } = require('../controllers/user-details-controller');
...
router.post('/signup', getSignupProcess);
...
router.post('/login', getLoginProcess);
...
router.get('/change_password', getChangePassword);
...
router.post('/change_password', getChangePasswordProcess);
...
//Login Process  Method
router.post('/forgot_password', getForgotPasswordProcess);
...
router.get('/user_details_display/:myid', getUserDetails);
// router.get('/user_details_display/:myid', function(req, res) {
...
router.get('/edit_form/:myid', function(req, res) {
    console.log( "id : ",req.params.myid);

    UsersModel.findById(req.params.myid, function(err, db_users_array) {
        if (err) {
            console.log("Edit Fetch Error " + err);
        } else {
            console.log("id : ",db_users_array);
...
router.post('/edit_form/:myid', function(req, res) {
    ...
    UsersModel.findByIdAndUpdate(req.params.myid, mybodydata, function(err) {
        if (err) {
            console.log("Error in Record Update");
            res.redirect('/user_details_display/:myid');
        } else {
