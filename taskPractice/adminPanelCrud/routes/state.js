...
const { addState, addStateProcess, displayStates, deleteState, editState, editStateProcess } = require('../controllers/adminControllers/state-controller');
var router = express.Router();

//Call User Database Model
var StateModel = require('../schema/state_table');

router.get('/add', addState );
router.post('/add', addStateProcess  );
router.get('/display', displayStates );
router.get('/delete/:id', deleteState );
router.get('/edit/:id',  editState );
router.post('/edit/:id', editStateProcess );
