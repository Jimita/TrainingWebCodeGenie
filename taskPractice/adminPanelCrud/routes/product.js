...
const { addProduct, addProductProcess, displayProducts, deleteProduct, editProduct, editProductProcess } = require('../controllers/adminControllers/product-controller');


router.get('/add', addProduct);
router.post('/add', addProductProcess );
router.get('/display', displayProducts);
router.get('/delete/:id', deleteProduct);
router.get('/edit/:id', editProduct );
router.post('/edit/:id', editProductProcess );
