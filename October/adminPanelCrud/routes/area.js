    ...
    AreaModel.find(function(err, db_area_array){
        ...
        AreaModel.find({})
          ...
          .exec(function(err, db_areas_array) {
            console.log("After population : ",db_areas_array);
          ...
          // console.log("string area array", area_array_store);
            res.render("area/display-area", { mydata: db_area_array, area_store: db_areas_array });
          })
      }).lean();
  });
                ...
                if(err){
                    ...
                    CityModel.find(function(err,db_city_array) {
                      if(err){
                          ...
                          res.render('area/edit-area', { mydata : db_area_array, state_array : db_state_array, city_array : db_city_array });
                      }
                  }).lean();
