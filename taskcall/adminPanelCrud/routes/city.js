...
const { addCity, addCityProcess, displayCities, deleteCity, editCity, editCityProcess } = require('../controllers/adminControllers/city-controller');
...
router.get('/add', addCity );
router.post('/add',  addCityProcess );
router.get('/display', displayCities );
router.get('/delete/:id', deleteCity );
router.get('/edit/:id',  editCity );
router.post('/edit/:id',  editCityProcess);
