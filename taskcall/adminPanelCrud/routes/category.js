...
// Controller 
const { addCategory, addCategoryProcess, displayCategories, deleteCategory, editCategory, editCategoryProcess } = require('../controllers/adminControllers/category-controller');
...
router.post('/add',  addCategoryProcess);
router.get('/display', displayCategories);
router.get('/delete/:id', deleteCategory);
router.get('/edit/:id', editCategory );
router.post('/edit/:id', editCategoryProcess );
