...
const {addUser, addUserProcess, displayUsers, deleteUser, editUser, editUserProcess, searchuser, searchuserProcess } = require('../controllers/adminControllers/user-controller');
...
router.post('/add', addUserProcess);
router.get('/display', displayUsers);
router.get('/delete/:id', deleteUser);
router.get('/edit/:id', editUser);
router.post('/edit/:id', editUserProcess);
router.get("/search", searchuser);
router.get("/searchuser", searchuserProcess);
